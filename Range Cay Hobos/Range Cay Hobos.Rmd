...
#each of the hobo logger files are named for the location on the pole that hobo logger was placed
...
#we cut each data file to start/end at times when we had data then plotted them all on top of each other
